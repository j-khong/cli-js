...
class Manual {
            ...
            actions: [
                {
                    ...
                    desc: 'this help',
                    switches: [],
                    action: (cliOptions) => { this.printHelp(cliOptions); }
                },
                {
                    name: "about",
                    desc: `Discover the purpose of ${this.getBinName()}`,
                    switches: [],
                    action: (cliOptions) => { this.about(cliOptions); }
                }]
        })
    ...
    getAppName() { return this.content.appName; }
    getBinName() { return this.content.binName; }
    getAppSubTitle() { return this.content.appSubTitle; }
    getAppVersion() { return this.content.appVersion; }
